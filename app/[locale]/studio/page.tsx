    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background-secondary to-background-tertiary">
      ...
      <div className="relative bg-surface/95 backdrop-blur-xl border-b border-border shadow-fitness-lg">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-surface-secondary border border-border rounded-lg p-6 text-center animate-fade-in">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6 sm:mb-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <div className="bg-surface-secondary border border-border rounded-lg p-4 sm:p-6">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-surface border border-border rounded-lg text-sm sm:text-base pl-10 sm:pl-12 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary text-text-primary placeholder-text-tertiary"
                />
              </div>
                  ...
                  <button
                    ...
                    className={`shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                      selectedFilter === filter
                        ...
                        : 'bg-surface border border-border text-text-secondary hover:text-text-primary hover:bg-surface-tertiary'
                    }`}
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              {studios.filter(s => s.featured).slice(0, 2).map((studio) => (
                <div key={studio.id} className="group relative">
                  ...
                  <Card className="relative bg-surface-secondary border-border hover:border-primary/50 transition-all duration-300 overflow-hidden z-10">
                    {/* Featured Badge */}
                        ...
                        <div className="flex-1 space-y-4">
                          <div>
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              {studio.verified && (
                                <div className="bg-success text-success-foreground px-2 py-1 rounded text-xs flex items-center gap-1">
                          ...
                          <div className="flex items-center gap-2">
                            {studio.specialties?.slice(0, 3).map((specialty) => (
                              <Badge key={specialty} variant="outline" className="border-primary/20 text-primary text-xs">
                                {specialty}
                              </Badge>
                            ))}
                          </div>
        ...
        <div className="mb-8">
          ...
          {filteredStudios.length === 0 ? (
            <div className="bg-surface-secondary border border-border rounded-lg p-12 text-center">
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
              {filteredStudios.map((studio) => (
                <div key={studio.id} className="animate-fade-in">
                  <Card className="bg-surface-secondary border-border overflow-hidden">
                      ...
                      <div className="flex-1 min-w-0 p-4 sm:p-6 space-y-4">
                        ...
                        <CardContent className="p-0 space-y-3">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {studio.specialties?.slice(0, 3).map((specialty) => (
                              <Badge key={specialty} variant="outline" className="border-primary/20 text-primary text-xs shrink-0">
                                {specialty}
                              </Badge>
                            ))}
                          </div>
                          ...
                          <div className="space-y-2 pt-3 border-t border-border">
                            ...
                            <button className="bg-primary text-primary-foreground hover:bg-primary/90 transition-colors rounded-lg w-full text-sm sm:text-base py-2 sm:py-3 font-medium">
                              View Classes & Book
                            </button>
                          </div>
                        </CardContent>
