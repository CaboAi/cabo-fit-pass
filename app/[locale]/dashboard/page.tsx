...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    let demoSession = localStorage.getItem('demo-session')
    let demoUser = localStorage.getItem('demo-user')
    
    // If demo parameter is present, set up demo session
    if (isDemoMode && (!demoSession || !demoUser)) {
      const demoUserData = {
      ...
      demoSession = 'true'
      demoUser = JSON.stringify(demoUserData)
    }
